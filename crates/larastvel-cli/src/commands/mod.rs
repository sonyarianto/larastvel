...
pub use make::{
    ...
    make_migration, make_model, make_notification, make_observer, make_policy, make_provider,
    make_resource, make_rule, make_scope, make_seeder, make_test, to_snake_case,
};
